...
# from prompts import WELCOME_MESSAGE, INSTRUCTIONS, CREATE_PATIENT
# import os
...
#     print("[Agent] Connected! Waiting for participants...")
...
#     def create_patient(msg: llm.ChatMessage):
#         session.conversation.item.create(
#             llm.ChatMessage(role="system", content=CREATE_PATIENT(msg))
#         )
#         session.response.create()
